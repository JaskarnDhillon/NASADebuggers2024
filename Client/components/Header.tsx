      ...
      <div className="w-full h-full flex flex-row items-center justify-between m-auto px-[10px]">
        ...
        <div className="w-[500px] h-full hidden lg:flex flex-row items-center justify-between">
          <div className="flex items-center justify-between w-full h-auto px-[20px] py-[10px] rounded-full text-gray-200">
            <Link
              href="/about"
              className="cursor-pointer duration-300 transition-all ease-in text-[#094b65] hover:bg-[#094b65] hover:text-[#fff] py-1 px-4 rounded-full"
            >
              About Us
            </Link>
            <Link
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              {headerLinks.map((item) => (
                <DropdownMenuItem
                  key={item.title}
                  className="py-2 px-4 rounded-[10px] text-sm"
                >
